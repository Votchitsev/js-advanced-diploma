...
## Навигация
[1 Описание игры](#1) <br>
Описание логики проекта:<br>
* [Game Controller](#2)
* [Computer Action](#3)
* [Draw Up](#4)


## <a name="#1"></a> Описание игры
...
### characterParse
В качестве аргумента принимает массив экземпляров 
